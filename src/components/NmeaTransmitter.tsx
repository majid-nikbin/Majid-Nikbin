          ...
          <div className="flex items-start sm:items-center gap-2.5">
            ...
            <div className="flex flex-col gap-0.5">
              ...
              <span className="text-[11px] text-amber-200/80">
                To continue physical hardware connectivity and NMEA data transmission, please upgrade via Myket.
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="flex flex-col gap-0.5">
              ...
              <span className="text-[11px] text-rose-300/80">
                To connect USB serial cables and broadcast NMEA data, please unlock the full version from Myket.
              </span>
            </div>
          </div>
          <button
          ...
          >
            ...
            <div className="p-3.5 bg-slate-950 rounded-xl border border-slate-800 flex flex-col gap-2.5">
              ...
              <p className="text-xs text-slate-300 leading-relaxed font-sans text-left" dir="ltr">
                Physical connection to USB OTG serial hardware and broadcasting NMEA sentences requires a license.
